    ...
    <>
      ...
      <div className="imagebg">
        <div className="row">
          ...
          <div className="col-lg-3 thumb thumbnail animate__animated animate__slideInLeft slow">
            <img className="img-thumbnail" src="47050024.jpg" alt="#" />
          </div>
          <div className="col-lg-3 thumb thumbnail animate__animated animate__slideInRight ">
            <img className="img-thumbnail" src="47060024.jpg" alt="#" />
          </div>
          <div className="col-lg-3 thumb thumbnail animate__animated animate__slideInRight slow">
