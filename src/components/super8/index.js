...
function Super8Content() {
  return (
    <div className="imagebg">
        <div class="container">
          <div class="row">
            <h1>PAGE TITLE</h1>
            <div class="col-12 col-md-6 col-xl-4 align-self-start animate__animated animate__slideInLeft">
              <div className="box1 animate bounce infinite">
                <h2>Super 8 Film</h2>
            ...
            <div class="col-12 col-md-6 col-xl-4 align-self-center animate__animated animate__slideInRight animate__delay-1s">
              <div className="box2">
                <h2>35mm Film</h2>
            ...
            <div class="col-12 col-md-12 col-xl-4 align-self-end">
              <div className="box3">
                <h2>120mm Film</h2>
